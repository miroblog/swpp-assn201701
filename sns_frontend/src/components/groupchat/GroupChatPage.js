  ...
  render() {
    ...
    return (
			<div style={styles.backgroundCover}>
		        ...
		        <GroupChatForm messages={this.props.messages} valid={this.props.valid}/>
		      </div>
				</div>
			</div>
    );
...
export default connect(mapStateToProps, mapDispatchToProps)(GroupChatPage);
